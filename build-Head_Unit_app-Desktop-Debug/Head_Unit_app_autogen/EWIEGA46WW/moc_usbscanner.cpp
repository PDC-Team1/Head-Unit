...
QT_MOC_LITERAL(1, 11, 13), // "mp3FilesFound"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "files"
QT_MOC_LITERAL(4, 32, 17) // "scanForUSBDevices"

    },
    "USBScanner\0mp3FilesFound\0\0files\0"
    "scanForUSBDevices"
};
...
void USBScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mp3FilesFound((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        case 1: _t->scanForUSBDevices(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&USBScanner::mp3FilesFound)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void USBScanner::mp3FilesFound(const QStringList & _t1)
{

...
QT_MOC_LITERAL(1, 10, 21), // "coverImagePathChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 11), // "loadMP3File"
QT_MOC_LITERAL(4, 45, 8), // "filePath"
QT_MOC_LITERAL(5, 54, 14) // "coverImagePath"

    },
    "MP3Player\0coverImagePathChanged\0\0"
    "loadMP3File\0filePath\0coverImagePath"
};
...
void MP3Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->coverImagePathChanged(); break;
        case 1: _t->loadMP3File((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MP3Player::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MP3Player::coverImagePathChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->coverImagePath(); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject MP3Player::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_MP3Player.data,
    qt_meta_data_MP3Player,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void MP3Player::coverImagePathChanged()
{
